...
export default function Footer() {
    ...
    return (
        <footer id="footer" className="w-full bg-primary mt-10">
            <div className="flex flex-col sm:flex-row justify-between gap-6 max-w-7xl mx-auto px-4 lg:px-8 py-8 md:py-10 relative">
                <div className="flex flex-col gap-4">
                    ...
                    <Link href={"/"}>
                        <Image src={"/logo-white.svg"} alt="Paw Fund Logo" width={160} height={50} className="w-auto h-10" />
                    </Link>
                ...
                <nav className="flex flex-col gap-4 sm:items-end justify-end md:justify-center">
                    <div className="flex gap-6">
                        <Link href={"/"} className="flex items-center gap-1 text-white font-bold group">
                            ...
                            <Image src={iconsAssets.ObliqueArrow} alt="ObliqueArrow" />
                        </Link>
                        <Link href={"/"} className="flex items-center gap-1 text-white font-bold group">
